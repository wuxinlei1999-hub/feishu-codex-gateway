...
const ROUTER_INSTRUCTIONS = [
  ...
  "Use management actions only when the user clearly asks to list/switch/create sessions, show current binding, change model, change reasoning effort, or show gateway help.",
  "Actions: delegate, list_sessions, current_session, new_session, switch_session, set_model, help.",
  ...
  "JSON shape: {\"action\":\"delegate|list_sessions|current_session|new_session|switch_session|set_model|help\",\"threadId\":\"\",\"threadIndex\":0,\"targetName\":\"\",\"threadName\":\"\",\"model\":\"\",\"reasoning\":\"\"}"
].join("\n");
...
function normalizeIntent(intent) {
  ...
  const allowed = new Set(["delegate", "list_sessions", "current_session", "new_session", "switch_session", "set_model", "help"]);
